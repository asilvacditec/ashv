    ...
    implements DrawingTool
{
    ...
    protected MouseEvent getTranslatedMouseEvent(MouseEvent evt, Rectangle cellRect)
    {
        ...
        Component component = (SwingUtilities.getAncestorOfClass(ext.egantt.swing.GanttTable.class, evt.getComponent()) == null ? evt.getComponent() : ((Component) (SwingUtilities.getAncestorOfClass(ext.egantt.swing.GanttTable.class, evt.getComponent()))));
