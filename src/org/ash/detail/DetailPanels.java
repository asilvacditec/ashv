...
public class DetailPanels extends JPanel{
	...
	private void initialize() {
		...
		this.networkChartPanel.addListenerReleaseMouse(this.statusBar);
		this.queuningChartPanel.addListenerReleaseMouse(this.statusBar);
		this.clusterChartPanel.addListenerReleaseMouse(this.statusBar);
		this.otherChartPanel.addListenerReleaseMouse(this.statusBar);
